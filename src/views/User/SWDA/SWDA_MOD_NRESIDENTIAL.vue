    ...
    <div class="col-12 col-md-9">
      ...
      <div class="tableOutside col-12">
        <div class="tableHeading">
          <p>CENTER-BASED NON-RESIDENTIAL MODE OF DELIVERY</p>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      PageDetail: "Center-Based Non-Residential Mode of Delivery",
      ...
      axios.get(`${backendURL}/api/swdalist`).then((res) => {
        this.swda = res.data.Swda.filter(
          (item) =>
            ...
            item.Mode_of_Delivery.includes("Center-based Non-Residential")
        );
        console.log(res);
      });
    },
