...
h1 {
  ...
  font-size: 15em;
  font-weight: 100;
  text-shadow: #f73636 1px 1px, #f73636 2px 2px, #f73636 3px 3px,
    #f73636 4px 4px, #f73636 5px 5px, #f73636 6px 6px, #f73636 7px 7px,
    #f73636 8px 8px, #f73636 9px 9px, #f73636 10px 10px, #f73636 11px 11px,
    #f73636 12px 12px, #f73636 13px 13px, #f73636 14px 14px, #f73636 15px 15px,
    #f73636 16px 16px, #f73636 17px 17px, #f73636 18px 18px, #f73636 19px 19px,
    #294d9c 20px 20px, #294d9c 21px 21px, #294d9c 22px 22px, #294d9c 23px 23px,
    #294d9c 24px 24px, #294d9c 25px 25px, #294d9c 26px 26px, #294d9c 27px 27px,
    #294d9c 28px 28px, #294d9c 29px 29px, #294d9c 30px 30px, #294d9c 31px 31px,
    #294d9c 32px 32px, #294d9c 33px 33px, #294d9c 34px 34px, #294d9c 35px 35px,
    #294d9c 36px 36px, #294d9c 37px 37px, #294d9c 38px 38px, #294d9c 39px 39px,
    #294d9c 40px 40px, #294d9c 41px 41px, #294d9c 42px 42px, #294d9c 43px 43px,
    #294d9c 44px 44px, #294d9c 45px 45px, #294d9c 46px 46px, #294d9c 47px 47px,
    #294d9c 48px 48px, #294d9c 49px 49px, #294d9c 50px 50px, #294d9c 51px 51px,
    #294d9c 52px 52px, #294d9c 53px 53px, #294d9c 54px 54px, #294d9c 55px 55px,
    #294d9c 56px 56px, #294d9c 57px 57px, #294d9c 58px 58px, #294d9c 59px 59px,
    #294d9c 60px 60px, #294d9c 61px 61px, #294d9c 62px 62px, #294d9c 63px 63px,
    #294d9c 64px 64px, #294d9c 65px 65px, #294d9c 66px 66px, #294d9c 67px 67px,
