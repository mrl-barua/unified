        ...
        <div class="container-fluid">
                ...
                <div class="mb-3 col-3">
                    ...
                    <select v-model="model.Swda.Type" class="form-control centered-placeholder" id="type">
                        <option :value="model.Swda.Type" selected>{{ model.Swda.Type }}</option>
                    ...
                    <div class="mb-3 col-3">
                        <div class="spaceBetween">
                            ...
                            <select v-model="model.Swda.Cluster" class="form-control centered-placeholder" id="cluster">
                               <option :value="model.Swda.Cluster" selected>{{ model.Swda.Cluster }}</option>
                               <option value="" disabled selected>
                                Select an option ⮟
                                </option>
                ...
                <div class="col-3">
                      ...
                      <div class="md-3 col-12 buttons d-flex justify-content-end">
                        ...
                        <router-link to="/adminswda">
                            <button @click="updateSWDA($route.params.ID)" class="btn btn-primary col-12">
                                Save
                            </button>
                        </router-link>
                    </div>
...
methods: {
 ...
 SwdaData(SwdaID) {
    axios.get(`http://127.0.0.1:8000/api/swdalist/${SwdaID}/edit`)
        .then(res => {
            ...
            this.model.Swda.Specified_Areas_of_Operation = swdaData.Specified_Areas_of_Operation;
            ...
            this.model.Swda.Registration_Expiration = swdaData.Registration_Expiration;
            ...
            this.model.Swda.Accreditation_Date_Issued = swdaData.Accreditation_Date_Issued;
            this.model.Swda.Accreditation_Expiration = swdaData.Accreditation_Expiration;
            ...
            this.model.Swda.Accreditation_Days_Left = swdaData.Accreditation_Days_Left;
            this.model.Swda.Accreditation_Overdue = swdaData.Accreditation_Overdue;
        })
   ...
   updateSWDA(SwdaID) {
    var mythis = this;
    axios.put(`http://127.0.0.1:8000/api/swdalist/${SwdaID}/edit`, this.model.Swda)
        .then((res) => {
